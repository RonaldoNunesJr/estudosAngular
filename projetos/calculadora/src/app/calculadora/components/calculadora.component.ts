...
export class CalculadoraComponent implements OnInit {
  ...
  adicionarNumero(numero: string): void {
    ...
    if (this.operacao === null) {
      this.numero1 = this.concatenarNumber(this.numero1, numero);
    } else {
      this.numero2 = this.concatenarNumber(this.numero2, numero);
    }
  }
   ...
   * @return string
   */
  concatenarNumber(numAtual: string, numConcat: string): string {
    ...
    // caso seja digitado um '.' e o mesmo já exista, apenas retorna o valor já digitado.
   ...
   * Caso já possua um operação selecionada, executa a
