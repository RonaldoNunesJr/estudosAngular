...
export class DashboardComponent implements OnInit {
  ...
  /**
   * Método chamado assim que a API de gráficos é inicalizada.
   * Responsável por chamar os métodos geradores do gráficos.
   * 
   * @return void
   */
   ...
   * responsável por definr os dados do gráfico.
   * 
   * @return any
   */
  obterDataTable(): any {
